function Banner() {
    return (
        ...
        <div className="relative z-10 max-w-[1000px]">
            ...
            <p className="mt-2 max-w-[850px] text-xs leading-snug text-white sm:text-sm lg:text-base xl:text-lg">
            Monitor and track all intern activities, including report submissions, leave requests, and profile updates.
            </p>
        </div>
        </div>
    );
