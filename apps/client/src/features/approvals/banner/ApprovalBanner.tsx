function Banner() {
    return (
        ...
        <div className="relative z-10 max-w-[820px]">
            ...
            <p className="mt-2 max-w-[1500px] text-xs leading-snug text-white sm:text-sm lg:text-base xl:text-lg">
            Review and manage pending end-of-day reports, leave requests, and profile updates for approval.
            </p>
        </div>
        </div>
    );
