        ...
        <div className="relative min-w-0 flex-1">
            ...
            {hasValue && (
                ...
                >
                    ...
                    <span className="pointer-events-none absolute right-1/2 top-full mb-1 hidden translate-x-1/2 rounded bg-black px-2 py-1 text-[10px] font-medium text-white shadow-md group-hover:block">
                        Clear
                    </span>
                </button>
            )}
