...
function ChangePasswordModal({ onSuccess, id }: ChangePasswordModalProps) {
    ...
    const validateSetupPassword = () => {
        ...
        if (!formValues.confirm_new_password.trim()) {
            ...
            formValues.new_password !== formValues.confirm_new_password
        ) {
                ...
                <div className="px-10 py-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3 text-left">
                        ...
                        <PasswordField
                            ...
                            onChange={(value) =>
                                handleChange('confirm_new_password', value)
                            }
                        />
